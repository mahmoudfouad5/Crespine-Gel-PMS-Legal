# Crespine Gel PMS Account Deletion
...
1. Open **Crespine Gel PMS**.
2. Sign in to your account.
3. Open the **Profile** screen.
4. Tap **Delete account**.
5. Confirm the request.
6. If required, complete phone verification using the one-time password (OTP).
...
- patient records
- submitted reports
- deletion status and deletion timestamp
